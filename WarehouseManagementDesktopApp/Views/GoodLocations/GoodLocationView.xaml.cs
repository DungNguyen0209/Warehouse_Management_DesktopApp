...
namespace WarehouseManagementDesktopApp.Views.GoodLocations
{
    ...
    public partial class GoodLocationView : UserControl
    {
        ...
        {
            InitializeComponent();
            double width = slotpanel.ActualWidth;
            double height = slotpanel.ActualHeight;
        ...
        ////private void UpdatUI(int width, int height, int depth, List<EmptyContainer> emptySlot)
        ////{
